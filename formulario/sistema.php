<?php
// Inclui o arquivo protect.php para proteger a página
include('protecct.php'); // Use o caminho correto para o arquivo

// Agora, continue com o código original da página
include_once('config.php'); // Conexão ao banco de dados

if (!empty($_GET['search'])) {
    $data = $_GET['search'];
    $sql = "SELECT * FROM usuario WHERE id LIKE '%$data%' OR username LIKE '%$data%' OR email LIKE '%$data%' ORDER BY id DESC";
} else {
...
// Código adicional para exibir os resultados, etc.
?>
<!DOCTYPE html>
<html lang="en">
<head>
